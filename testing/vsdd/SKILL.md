---
name: vsdd
description: Verified Spec-Driven Development — a unified AI-native methodology fusing Spec-Driven, Test-Driven, and Verification-Driven Development. Use this skill when the user wants to build software with rigorous specs-first, red-green-refactor TDD, adversarial code review, and formal verification. Ideal for correctness-critical systems (financial, medical, infrastructure) or when maximum code quality is required.
---
...
**Verified Spec-Driven Development (VSDD)** is a unified software engineering methodology that fuses three proven paradigms into a single AI-orchestrated：
